...
var getFullNames = function (inputArry) {

   for (var i = 0 ; i < inputArry.length ; i += 1){
      var fullName
      //console.log(inputArry[i]);
      //console.log(customers[i].first);
      fullName = customers[i].first + " " + customers[i].last
      listofNamesArry.push(fullName);
      }
      //Output Array of Strings
      //console.log(fullName);
      console.log(listofNamesArry);
      return listofNamesArry
   }
...
//INPUT Arry of Strings

var createListOfObjects = function (inputArray) {

   var listOfNamesObject = []

   for (var i = 0; i < inputArray.length; i++) {
      //console.log(inputArray[i]);

      var singleNameArr = inputArray[i].split(" ");
      //console.log(singleNameArr);

      //namesTitleStr = "firstName: " + singleNameArr[0] + " lastName: " +singleNameArr[1]
      //console.log(namesTitleStr);

      var nameObj = {
         firstName : singleNameArr[0],
         lastName : singleNameArr[1],
      }
      //console.log(nameObj);

      listOfNamesObject.push(nameObj)
...
//
// //input string
// var generateDog = function (inputObj) {
//    var dog = {
//        name : 'inputObj[0]',
//        legs : 4,
//    }
...
var getCounts = function (strOfText) {
   ...
   var arrOfWords = strOfText.toLowerCase().split(" ")

   for (var i = 0; i < arrOfWords.length; i++) {
      //console.log(arrOfWords[i])
      var theWord = arrOfWords[i]

      if (typeof wordCountObject[theWord] === 'undefined'){
         wordCountObject[theWord] = 1
      } else {
         wordCountObject[theWord] = wordCountObject[theWord] + 1
      }
   ...
   //output: object -- wordCount directory
